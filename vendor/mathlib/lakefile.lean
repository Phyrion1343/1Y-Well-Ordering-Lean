...
require "leanprover-community" / "batteries" from "../batteries"
require "leanprover-community" / "Qq" from "../Qq"

require "leanprover-community" / "aesop" from "../aesop"
require "leanprover-community" / "proofwidgets" from "../proofwidgets"
  with NameMap.empty.insert `errorOnBuild
    "ProofWidgets failed to reuse pre-built JS code. \
    Please report this issue on the Lean Zulip."
require "leanprover-community" / "importGraph" from "../importGraph"
require "leanprover-community" / "LeanSearchClient" from "../LeanSearchClient"
require "leanprover-community" / "plausible" from "../plausible"
...
-- Vendored distribution: dependency updates remain local and do not download caches.
